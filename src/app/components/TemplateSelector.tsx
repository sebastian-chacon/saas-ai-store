          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-center">
              ...
              <div className="relative">
                ...
                <Card className={`relative overflow-hidden border-white/10 bg-[#050505] shadow-[0_0_80px_-20px_rgba(168,85,247,0.3)] transition-all duration-700 ${
                  previewDevice === 'mobile' ? 'w-75 h-125 mx-auto rounded-[3rem] border-8 border-slate-900' : 'w-full aspect-4/5 rounded-[2.5rem]'
                }`}>
